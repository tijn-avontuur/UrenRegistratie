<flux:modal wire:model="show" class="md:w-96">
    <form wire:submit="update">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg" class="text-gray-900">Tijdsregistratie Bewerken</flux:heading>
                <flux:text class="text-gray-700">Wijzig de gewerkte uren.</flux:text>
            </div>
            ...
            <div class="flex gap-2">
                <flux:button type="submit" variant="primary">Bijwerken</flux:button>
