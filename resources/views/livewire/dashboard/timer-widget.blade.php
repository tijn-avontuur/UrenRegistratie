<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
    <div class="flex flex-col items-center">
        ...
        <div class="text-4xl font-bold mb-6" style="letter-spacing: 0.1em; color: #422AD5;" x-data="{
            elapsed: @entangle('elapsedTime').live,
            interval: null,
            isRunning: @entangle('isRunning').live
        }"
            x-init="$watch('isRunning', value => {
                if (value && !interval) {
        ...
        <button wire:click="toggleTimer" @if (count($projects) === 0 && !$isRunning) disabled @endif
    ...
    @if ($showStopModal)
        <div class="fixed inset-0 z-50 overflow-y-auto" x-data="{ show: @entangle('showStopModal').live }" x-show="show" style="display: none;">
            <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                <!-- Background overlay -->
                <div class="fixed inset-0 transition-opacity bg-gray-500 bg-opacity-75" @click="$wire.cancelStop()"
                ...
                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            <div
                                class="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-[#422AD5] bg-opacity-10 sm:mx-0 sm:h-10 sm:w-10">
                                <svg class="h-6 w-6 text-[#422AD5]" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
                                ...
                                <div class="mt-4 space-y-3">
                                    ...
                                    <div
                                        class="flex justify-between items-center py-2 bg-[#422AD5] bg-opacity-5 rounded-lg px-3">
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse gap-2">
                        <button wire:click="confirmStop" type="button"
                        ...
                        <button wire:click="discardTimer" type="button"
                        ...
                        <button wire:click="cancelStop" type="button"
