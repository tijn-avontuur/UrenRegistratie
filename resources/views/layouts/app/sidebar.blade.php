        ...
        <div class="hidden lg:flex flex-col w-64 bg-white border-r border-gray-200">
            ...
            <nav class="flex-1 p-4 space-y-1">
                ...
                <a href="{{ route('kalender') }}"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('kalender') ? 'bg-[#422AD5] text-white' : 'text-gray-700 hover:bg-gray-100' }} transition-colors"
                    wire:navigate>
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('projecten') }}"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('projecten') ? 'bg-[#422AD5] text-white' : 'text-gray-700 hover:bg-gray-100' }} transition-colors"
                    wire:navigate>
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
