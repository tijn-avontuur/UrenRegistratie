    ...
    <div class="space-y-6">
        ...
        <div class="flex justify-center">
            <div class="rounded-full bg-warning/20 p-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-warning" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
        ...
        <div class="alert alert-info">
            ...
            <div class="flex flex-col">
                <span
                    class="font-semibold">{{ __('Nieuwe gebruikers kunnen alleen worden aangemaakt door een administrator.') }}</span>
