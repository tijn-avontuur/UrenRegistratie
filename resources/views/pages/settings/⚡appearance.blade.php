        ...
        <div x-data="{ appearance: $flux.appearance }">
            ...
            <div class="grid grid-cols-3 gap-3">
                ...
                <button type="button" @click="$flux.appearance = 'light'"
                    ...
                    <span class="text-sm font-medium text-gray-700">{{ __('Licht') }}</span>
                </button>
                ...
                <button type="button" @click="$flux.appearance = 'dark'"
                    ...
                    <span class="text-sm font-medium text-gray-700">{{ __('Donker') }}</span>
                </button>
                ...
                <button type="button" @click="$flux.appearance = 'system'"
                    ...
                    <span class="text-sm font-medium text-gray-700">{{ __('Systeem') }}</span>
                </button>
            </div>
        </div>
